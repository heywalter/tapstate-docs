...
In `v0.2.1`, use target row counts and representative keyed samples as the primary snapshot proof. An empty `snapshot` result alone does not establish success or failure.

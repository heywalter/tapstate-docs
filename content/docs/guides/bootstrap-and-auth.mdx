...
The [local demo](/docs/overview/quickstart-online) performs these steps automatically. Follow this page when operating the server directly.

## Before you begin

- Start a `v0.2.0` server with its control port bound to loopback or another protected interface.
...
The demo treats both results as an established administrator: `204` means it created the user; `409` means the bootstrap window was already closed.
...
In `v0.2.0`, connected verbs can run inside this interactive session or as

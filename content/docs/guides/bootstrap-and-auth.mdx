...
- Start a `v0.2.1` server with its control port bound to loopback or another protected interface.
...
In `v0.2.1`, connected verbs can run inside this interactive session or as

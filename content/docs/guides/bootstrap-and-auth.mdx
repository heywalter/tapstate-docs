...
- Start a `v0.3.0` server with its control port bound to loopback or another protected interface.
...
In `v0.3.0`, connected verbs can run inside this interactive session or as
